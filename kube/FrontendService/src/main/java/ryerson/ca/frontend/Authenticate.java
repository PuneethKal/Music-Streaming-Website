...
public class Authenticate {
    ...
    public Authenticate() {
        ...
        secretString = Encoders.BASE64.encode("mysecuresecurecodeisnotlongenoughenoughenough".getBytes());
    ...
    public Entry<Boolean, String> verify(String jwt) throws UnsupportedEncodingException {
        ...
        try {
            jws = Jwts.parserBuilder() // (1)
                    .setSigningKey("mysecuresecurecodeisnotlongenoughenoughenough") // (2)
                    .require("alg", "HS256")
                    .build() // (3)
            ...
            System.out.println(" we *cannot* use the JWT as intended by its creator" + ex);
        }        
